...
if __name__ == '__main__':
    ...
    #bosdyn.client.util.add_payload_credentials_arguments(parser) ### SDL COMMENTED OUT
    ...
    bosdyn.client.util.authenticate(robot) ### SDL: Use env var instead of payload credentials
